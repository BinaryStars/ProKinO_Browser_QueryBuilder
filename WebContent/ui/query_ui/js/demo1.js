 ...
 */
    ...
    instance.bind("click", function (connection, originalEvent) {
    	...
    	if (connection.getPaintStyle().strokeStyle === "#ADD8E6") {
            ...
            var triple = "?" + $("#" + connection.sourceId).attr("name").toLowerCase().replace(" ","")+source_instance_id +
                " " + prefix + ":" + connection.getOverlay(connection.sourceId+"-"+connection.targetId).getLabel()+ " ?" + $("#" + connection.targetId).attr("name").toLowerCase().replace(" ","")+target_instance_id + '.\n';
